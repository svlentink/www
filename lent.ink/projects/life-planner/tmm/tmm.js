...
function tmmToOneFormat() {
  ...
  for (var ai in arguments){//(var a=0; a < arguments.length; a++){
...
function rendertmm(elemid, items) {
  ...
  row1t = document.createElement('th')
  ...
  row2t = document.createElement('th')
